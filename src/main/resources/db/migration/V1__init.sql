...
(
    ...
    PRIMARY KEY (`id`),
    INDEX `fk_trip_plan_budget1_idx` (`budget_id` ASC) VISIBLE
)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_unicode_ci;
...
(
    ...
    `budget_id`    BIGINT   NOT NULL,
    PRIMARY KEY (`id`),
    INDEX `fk_trip_member_trip_plan1_idx` (`trip_plan_id` ASC) VISIBLE,
    INDEX `fk_trip_member_user1_idx` (`user_id` ASC) VISIBLE,
    INDEX `fk_trip_member_budget1_idx` (`budget_id` ASC) VISIBLE
)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_unicode_ci;
...
(
    ...
    `budget_id`      BIGINT       NOT NULL,
    PRIMARY KEY (`id`),
    INDEX `fk_pay_case_category1_idx` (`category_id` ASC) VISIBLE,
    INDEX `fk_payment_case_budget1_idx` (`budget_id` ASC) VISIBLE
)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_unicode_ci;
